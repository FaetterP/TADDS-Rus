...
translate russian strings:
    ...
    new "Продвигает диалог, не выбирая варианты."
    ...
    new "Пропускает диалог, пока клавиша удерживается."
    ...
    new "Переключает режим пропуска диалога."
    ...
    new "Включает или выключает вспомогательное {a=https://www.renpy.org/l/voicing}самоозвучивание{/a}."
