...
translate russian strings:
    ...
    new "При использовании сенсорного экрана поддержка самоозвучивания ограничена."
    ...
    new "Параметры этого меню предназначены для улучшения доступности. Они могут работать не во всех играх, а некоторые сочетания параметров могут сделать игру непроходимой. Это не является проблемой игры или движка. Для наилучших результатов при смене шрифта старайтесь сохранять размер текста таким же, как был изначально."
    ...
    new "Интерактивный режиссер здесь не включен."
    ...
    new "Нажмите, чтобы задать; щелкните правой кнопкой, чтобы добавить в список позади."
    ...
    new "При загрузке несохраненный прогресс будет потерян.\nВы уверены, что хотите продолжить?"
    ...
    new "Вы уверены, что хотите продолжить с места, где остановились?"
    ...
    new "Это сохранение было создано на другом устройстве. Злонамеренно созданные файлы сохранений могут нанести вред вашему компьютеру. Вы доверяете создателю этого сохранения и всем, кто мог изменить этот файл?"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "Вы доверяете устройству, на котором было создано это сохранение? Вы должны выбирать да, только если являетесь единственным пользователем этого устройства."
    ...
    new "Самоозвучивание произнесло бы \"[renpy.display.tts.last]\". Нажмите 'alt+shift+V', чтобы отключить."
    ...
    new "(очистить сохраненные пузыри)"
    ...
    new "Сервер синхронизации Ren'Py не имеет копии этой синхронизации. Идентификатор синхронизации может быть недействителен или срок его действия истек."

    # renpy/common/00sync.rpy:305
    old "Please enter the sync ID you generated.\nNever enter a sync ID you didn't create yourself."
    new "Пожалуйста, введите созданный вами ID синхронизации.\nНикогда не вводите ID синхронизации, который создали не вы."
    ...
    new "Это свяжется с {a=https://sync.renpy.org}сервером синхронизации Ren'Py{/a}."
    ...
    new "У этой учетной записи нет прав для выполнения обновления."

    # renpy/common/00updater.rpy:880
    old "This account does not have permission to write the update log."
    new "У этой учетной записи нет прав для записи журнала обновления."
    ...
    new "У файла обновления неверная контрольная сумма, возможно, он поврежден."
    ...
    new "Доступна версия [u.version]. Хотите установить ее?"
    ...
    new "Эта игра не может быть запущена, пока не будут загружены данные игры."
    ...
    new "Включить (без списка блокировки)"
    ...
    new "Для этой игры требуется GL2, который не удалось инициализировать."

    # renpy/common/00gltest.rpy:216
    old "This computer has a problem displaying graphics: [problem]."
    new "У этого компьютера возникла проблема с отображением графики: [problem]."

    # renpy/common/00gltest.rpy:220
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Его графические драйверы могут быть устаревшими или работать некорректно. Это может привести к медленному или неправильному отображению графики."
    ...
    new "Пытается выполнить откат к более раннему моменту, позволяя вам сохранить игру или выбрать другой вариант."
