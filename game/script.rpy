...
define j = Character(_("JAX"))
define r = Character(_("RAGATHA"))
define g = Character(_("GANGLE"))
define p = Character(_("POMNI"))
define z = Character(_("ZOOBLE"))
define k = Character(_("KINGER"))
define c = Character(_("CAINE"))
define b = Character(_("BUBBLE"))
define a = Character("[avatar.upper()]")
define zg = Character(_("ZOOBLE & GANGLE"))
define rp = Character (_("RAGATHA & POMNI"))
define x = Character (_("XDDCC"))
define n = Character (_("NPC"))
define m = Character (_("MING"))
define sb = Character (_("SIR BASTION"))
...
define r_nvl = Character(_("RAGATHA"), kind=nvl, callback=Phone_ReceiveSound)
define g_nvl = Character(_("GANGLE"), kind=nvl, callback=Phone_ReceiveSound)
define p_nvl = Character(_("POMNI"), kind=nvl, callback=Phone_ReceiveSound)
define z_nvl = Character(_("ZOOBLE"), kind=nvl, callback=Phone_ReceiveSound)
define x_nvl = Character(_("XDDCC"), kind=nvl, callback=Phone_ReceiveSound)
