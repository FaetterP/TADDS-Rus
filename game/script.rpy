...
define pa = Character ("POMNI & [avatar.upper()]")
define cbd = Character ("COL. BAD DAD")
define dg = Character ("DISAPPEARING GUY")
define ja = Character ("JAX & [avatar.upper()]")
define jk = Character ("JAX & KINGER")
define pj = Character ("POMNI & JAX")
define un = Character ("UZUMAKI NINJA")
define ej = Character ("EVIL JAX")
define ejj = Character ("JAX?")
define o = Character ("ORBSMAN")
define ep = Character ("EVIL POMNI")
define mc = Character ("MC")
define au = Character ("AUDIENCE")
define za = Character ("ZOOBLE & [avatar.upper()]")
define w = Character ("WAITER")
define cv = Character ("CAINE'S VOICE")
define gg = Character ("GUMMIGOO")
define cb = Character ("CAINE & BUBBLE")
